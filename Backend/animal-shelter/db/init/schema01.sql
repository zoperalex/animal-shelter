...
CREATE SEQUENCE IF NOT EXISTS public.animal_image_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE IF NOT EXISTS public.breed_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE TABLE IF NOT EXISTS public.animal_image (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	image bytea NULL,
	"name" varchar(255) NULL,
